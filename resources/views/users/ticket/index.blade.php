                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 min-h-[500px]">
                    ...
                    <div class="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
                        <div>
                            ...
                            <p class="text-gray-500 text-sm">Lihat Tiket Kamu.</p>
                        </div>
                                ...
                                <div class="flex flex-col md:flex-row gap-4 border border-gray-100 rounded-xl p-4 hover:shadow-md transition bg-white items-stretch">
                                    ...
                                    <div class="flex-1 flex flex-col justify-between py-1">
                                        <div>
                                            ...
                                            <!-- Title -->
                                            <h3 class="font-bold text-gray-800 text-lg line-clamp-1 mb-1">{{ $ticket->event?->name ?? 'Event Dihapus' }}</h3>
                                    ...
                                    <div class="flex flex-col justify-center items-end gap-2 min-w-[140px] border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-4">
                                        ...
                                        @if($ticket->status == 'success')
                                            <!-- TIKET SUDAH DIBAYAR -->
                                            <a href="{{ route('event.detail', $ticket->event_id) }}" class="w-full bg-[#4838CC] hover:bg-[#3b2db0] text-white text-xs font-bold py-2.5 px-4 rounded-lg text-center transition shadow-md">
                                                View E-Ticket
                                            </a>
                                        ...
                                        @elseif($ticket->status == 'pending')
                                            ...
                                            @if($ticket->payment_url)
                                                <a href="{{ $ticket->payment_url }}" target="_blank" class="w-full bg-[#FF6B00] hover:bg-[#e65a00] text-white text-xs font-bold py-2.5 px-4 rounded-lg text-center transition shadow-md animate-pulse">
                                                    Bayar Sekarang
                                                </a>
                                            @else
                    ...
                    @else
                        ...
                        <div class="text-center py-20 bg-gray-50 rounded-2xl border border-dashed border-gray-300">
                            ...
                            <h3 class="text-lg font-bold text-gray-800">Kamu Belum Punya Tiket</h3>
                            <p class="text-gray-500 text-sm mt-1 mb-6">Temukan event dan pesan tiket sekarang!</p>
