                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="text-gray-400 text-xs border-b border-gray-100">
                            ...
                            <th class="py-4 px-4 font-normal">Date</th>
                            <th class="py-4 px-4 font-normal">Category</th>
                            <th class="py-4 px-4 font-normal">Price</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-8 text-gray-500">No events found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                <div
                    ...
                    <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="px-6 py-6 space-y-4">
                            ...
                            <div class="w-full">
                                <label
                                    ...
                                    <div id="create-placeholder"
                                        ...
                                        <p class="text-sm text-gray-500 font-medium">Input Your Poster</p>
                                    </div>
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-600 mb-1">Detail Event</label>
