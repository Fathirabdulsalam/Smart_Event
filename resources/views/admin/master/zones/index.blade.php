...
@section('content')
            ...
            <table class="w-full text-left border-collapse">
                <thead class="bg-gray-50 text-gray-500 text-xs uppercase">
                    <tr>
                        ...
                        <th class="py-4 px-4">Nama Zona</th>
                        <th class="py-4 px-4">Zona Waktu</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @empty
                    <tr><td colspan="4" class="text-center py-8 text-gray-500">Tidak ada zona yang ditemukan.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto flex items-center justify-center p-4">
            <div class="relative transform rounded-xl bg-white text-left shadow-xl transition-all sm:w-full sm:max-w-md border border-gray-200">
                <div class="bg-white px-6 py-6">
                    <h3 class="text-lg font-bold text-[#6C5DD3] mb-4 border-b pb-2">Tambah Zona Waktu</h3>
    ...
    <div id="editModal" class="relative z-50 hidden" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto flex items-center justify-center p-4">
            <div class="relative transform rounded-xl bg-white text-left shadow-xl transition-all sm:w-full sm:max-w-md border border-gray-200">
                <div class="bg-white px-6 py-6">
                    <h3 class="text-lg font-bold text-[#6C5DD3] mb-4 border-b pb-2">Edit Zona Watu</h3>
